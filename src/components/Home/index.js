...
import TopRatedSection from '../TopRatedMovies'
import OriginalMoviesSlick from '../OriginalMovieSlick'
...
class Home extends Component {
    ...
    return (
      ...
      >
        ...
        <div className="movie-heading-container">
          <h1 className="poster-title">{posterImage.name}</h1>
  ...
  getOriginalData = () => this.getOriginalsData
  ...
  renderOriginalsSuccessView = () => {
    const {originalsData} = this.state
    return <OriginalMoviesSlick originalMoviesData={originalsData} />
  }

  retryApi = () => this.getOriginalsData
